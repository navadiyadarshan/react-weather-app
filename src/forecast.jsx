...
const WeatherApp = () => {
  ...
  const handleSearch = () => {
    setWeatherData({
      ...
      date: 'Sunday, Jan 27 at 12:00 PM',
      sunrise: '6:30 AM',
      sunset: '6:00 PM',
      humidity: '60%',
